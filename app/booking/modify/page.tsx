  ...
  const handleSearch = () => {
    ...
    if (bookingReference && lastName) {
      const booking = bookingsData.find(
        (b) => b.reference === bookingReference
      );
      if (booking) {
        ...
        alert(
          "Booking not found. Please check your reference number and last name."
        );
      }
    }
  };
        ...
        <div className="container py-6">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Change your journey details, passenger information, or seat
              selection
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <TabsList className="grid w-full grid-cols-3">
                <TabsTrigger
                  value="find"
                  disabled={activeTab !== "find" && activeTab !== "select"}
                >
                  Find Booking
                </TabsTrigger>
                <TabsTrigger
                  value="modify"
                  disabled={activeTab !== "modify" && activeTab !== "select"}
                >
                  Modify Details
                </TabsTrigger>
                ...
                >
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Enter your booking reference and last name to find your
                        journey
                      </CardDescription>
                    </CardHeader>
                  ...
                  {selectedBooking && (
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Choose what you would like to change about your
                          booking
                        </CardDescription>
                      </CardHeader>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 mb-4">
                            <div className="space-y-1">
                              <div className="text-lg font-bold">
                                {selectedBooking.from.time}
                              </div>
                              <div className="font-medium">
                                {selectedBooking.from.city}
                              </div>
                              <div className="text-xs text-muted-foreground">
                                {selectedBooking.from.terminal}
                              </div>
                            </div>
                            ...
                            <div className="space-y-1">
                              <div className="text-lg font-bold">
                                {selectedBooking.to.time}
                              </div>
                              <div className="font-medium">
                                {selectedBooking.to.city}
                              </div>
                              <div className="text-xs text-muted-foreground">
                                {selectedBooking.to.terminal}
                              </div>
                            </div>
                          </div>
                  ...
                  {selectedBooking && modifyType && (
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          {modifyType === "date" &&
                            "Select a new date for your journey"}
                          {modifyType === "passenger" &&
                            "Update the passenger information"}
                          {modifyType === "seat" &&
                            "Choose a new seat for your journey"}
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        {modifyType === "date" && (
                                ...
                                <div>
                                  <p className="font-medium">
                                    {priceDifference > 0
                                      ...
                                      : `You will receive a refund of ₦${Math.abs(
                                          priceDifference
                                        ).toLocaleString()}`}
                                  </p>
                                  <p className="text-sm text-muted-foreground">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="space-y-2">
                                ...
                                <Input
                                  id="email"
                                  type="email"
                                  defaultValue="anna.anderson@example.com"
                                />
                              </div>
                              <div className="space-y-2">
                            ...
                            <div className="p-4 bg-amber-50 dark:bg-amber-950/30 rounded-md flex items-start gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  The passenger name must match the ID that will
                                  be presented at check-in. Some operators may
                                  charge a fee for name corrections.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        {modifyType === "seat" && (
                          <div className="space-y-4">
                            <div className="space-y-2">
                              ...
                              <div className="p-2 bg-muted rounded-md">
                                <span className="font-medium">
                                  {selectedBooking.passenger.seat}
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="p-4 bg-muted rounded-md">
                              ...
                              <p className="text-sm text-muted-foreground">
                                Premium seats may incur an additional fee. Your
                                current seat is a standard seat.
                              </p>
                            </div>
                          </div>
                        )}
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-muted-foreground">
                          {modifyType === "date" &&
                            "Your journey has been rescheduled to the new date."}
                          {modifyType === "passenger" &&
                            "The passenger details have been updated."}
                          {modifyType === "seat" &&
                      ...
                      <div className="p-4 bg-muted rounded-md">
                        ...
                        <ul className="space-y-2 text-sm">
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              An updated e-ticket has been sent to your email
                              address.
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-muted-foreground">•</span>
                            <span>
                              You can view and download your updated ticket from
                              your account.
                            </span>
                          </li>
                          {modifyType === "date" && priceDifference > 0 && (
                            <li className="flex items-start gap-2">
                              <span className="text-muted-foreground">•</span>
                              <span>
                                The additional payment has been charged to your
