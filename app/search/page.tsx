...
export default function SearchPage() {
  ...
  const handleTransitChange = (value: string) => {
    setTransitFilter((prev) => (prev.includes(value) ? prev.filter((item) => item !== value) : [...prev, value]))
  }

  const handleTransitPointChange = (value: string) => {
    setTransitPointFilter((prev) => (prev.includes(value) ? prev.filter((item) => item !== value) : [...prev, value]))
  }
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="flex-1 bg-background rounded-lg p-4 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <Input
                  type="text"
                  placeholder="From: Lagos"
                  className="max-w-[150px] h-8 text-sm"
                  defaultValue="Lagos"
                />
                <ArrowRight className="h-4 w-4" />
                <Input type="text" placeholder="To: Abuja" className="max-w-[150px] h-8 text-sm" defaultValue="Abuja" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] gap-6">
            <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={() => handleTransitChange("1transit")}
                      />
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={() => handleTransitPointChange("ibadan")}
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={() => handleTransitPointChange("ilorin")}
                      />
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-medium">Transit duration</h3>
                    <Button variant="ghost" size="sm" className="h-8 text-xs">
                      Reset
                    </Button>
                  </div>
                  <div className="py-4">
                    <Slider defaultValue={[0]} max={22} step={1} />
                    <div className="flex justify-between mt-2">
                      <span className="text-xs">0h</span>
                      <span className="text-xs">19h</span>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center text-sm text-muted-foreground">
                  <span>Prices are currently typical</span>
                      ...
                      <CardContent className="p-0">
                        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-4 p-4 items-center">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <div className="text-sm font-medium">{route.company}</div>
                              <div className="text-xs text-muted-foreground">23kg</div>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-2 items-center">
                            <div className="text-center">
                              ...
                              <div className="text-xs text-muted-foreground">Lagos</div>
                            </div>
                              ...
                              <div className="relative w-16 md:w-24">
                                ...
                                <div className="relative flex justify-center">
                                  <span className="bg-background px-2 text-xs text-muted-foreground">
                                    {route.stops === 0 ? "Direct" : `${route.stops} stop`}
                                  </span>
                                </div>
                              </div>
                            </div>
                            <div className="text-center">
                              ...
                              <div className="text-xs text-muted-foreground">Abuja</div>
                            </div>
                          </div>
