...
//               </FormControl>
//               <FormDescription>
//                 This description is automatically generated based on the route
//                 details
//               </FormDescription>
//               <FormMessage />
//             </FormItem>
...
//               <div key={field.id} className="p-4 border-b">
//                 <div className="flex items-center justify-between mb-4">
//                   <h4 className="font-medium">Bus Assignment {index + 1}</h4>
//                   <Button
//                     type="button"
//                     variant="ghost"
//                     size="sm"
...
//                                 {bus.busNumber} - {bus.busModel} ({bus.capacity}{" "}
//                                 seats)
//                               </SelectItem>
//                             ))}
//                           </SelectContent>
